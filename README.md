...
| 0.4 Loki              | ❌ No                      |                                                                             |
| 5 Juno / 5.1 Hera     | ❌ No                      |                                                                             |
| 6 Odin / 6.1 Jólnir   | ⚠️ Yes, but not well tested | Known issue: some icons shown as missing due to older version of icon theme |
| 7 / 7.1 Horus         | ⚠️ Yes, but not well tested |                                                                             |
| 8 / 8.1 Circe         | ✅ Yes                     |                                                                             |
| 9 Tanit               | ✅ Yes                     |                                                                             |
